...
namespace RuntimeHandle
{
    ...
    public class PositionPlane : HandleBase
    {
        ...
        public override void Interact(Vector3 p_previousPosition)
        {
            ...
            _parentTransformHandle.target.transform.position = position;
        ...
        public override void StartInteraction(Vector3 p_hitPoint)
        {
            Vector3 rperp = _parentTransformHandle.space == HandleSpace.LOCAL
                ? _parentTransformHandle.target.transform.rotation * _perp
                : _perp;
            
            _plane = new Plane(rperp, _parentTransformHandle.target.transform.position);
            ...
            Vector3 hitPoint = ray.GetPoint(d);
            _startPosition = _parentTransformHandle.target.transform.position;
        ...
        void Update()
        {
            ...
            Vector3 raxis1 = _parentTransformHandle.space == HandleSpace.LOCAL
                ? _parentTransformHandle.target.transform.rotation * axis1
                : axis1;
            ...
            Vector3 raxis2 = _parentTransformHandle.space == HandleSpace.LOCAL
                ? _parentTransformHandle.target.transform.rotation * axis2
                : axis2;
