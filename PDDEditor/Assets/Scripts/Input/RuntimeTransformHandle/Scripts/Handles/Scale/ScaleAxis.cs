...
namespace RuntimeHandle
{
    ...
    public class ScaleAxis : HandleBase
    {
        ...
        public override void Interact(Vector3 p_previousPosition)
        {
            ...
            float distance = Vector3.Distance(_parentTransformHandle.target.transform.position, hitPoint);
            ...
            _parentTransformHandle.target.transform.localScale = scale;
        ...
        public override void StartInteraction(Vector3 p_hitPoint)
        {
            ...
            _startScale = _parentTransformHandle.target.transform.localScale;

            Vector3 raxis = _parentTransformHandle.space == HandleSpace.LOCAL
                ? _parentTransformHandle.target.transform.rotation * _axis
                : _axis;
            
            _raxisRay = new Ray(_parentTransformHandle.target.transform.position, raxis);
            ...
            _interactionDistance = Vector3.Distance(_parentTransformHandle.target.transform.position, hitPoint);
        }
    }
}