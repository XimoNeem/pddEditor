...
namespace RuntimeHandle
{
    ...
    public class ScaleGlobal : HandleBase
    {
        ...
        public override void Interact(Vector3 p_previousPosition)
        {
            ...
            delta += d;
            _parentTransformHandle.target.gameObject.transform.localScale = _startScale + Vector3.Scale(_startScale,_axis) * delta;
        ...
        public override void StartInteraction(Vector3 p_hitPoint)
        {
            ...
            _startScale = _parentTransformHandle.target.gameObject.transform.localScale;
        }
    }
}